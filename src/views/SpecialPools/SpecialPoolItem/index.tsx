import { Button, Flex, Heading, Text } from '@defifarms/uikit'
    ...
    <ItemWrap>
      ...
      <BodyItem>
        <Flex flexDirection="column" mb="24px">
          ...
          <Text>{t('Stake token DEFY, BSUD, WBNB, BTCT, ATTH, CAKE and ern $DEFIY')}</Text>
        </Flex>
        ...
        <Flex alignItems="center" justifyContent="center" mb="16px">
          <Button as={Link} variant="four" scale="md" to={`/special-pools/${poolConfig.link}`}>

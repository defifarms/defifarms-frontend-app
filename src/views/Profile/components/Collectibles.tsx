  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Defifarms Collectibles')}
      </Heading>
      <Text as="p">
        {t('Defifarms Collectibles are special ERC-721 NFTs that can be used on the Defifarms platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Defifarms Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Defifarms Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )

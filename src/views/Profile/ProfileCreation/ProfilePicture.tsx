    ...
    return (
      <>
        ...
        <Text bold fontSize="20px" mb="24px">
          {t('We couldn’t find any Defifarms Collectibles in your wallet.')}
        </Text>
        <Text as="p">
          {t(
            'You need a Defifarms Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t('Only approved Defifarms Collectibles can be used.')}

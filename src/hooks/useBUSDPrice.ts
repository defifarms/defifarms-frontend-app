import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@defifarms/sdk'
import { useMemo } from 'react'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import { BUSD, DEFIY } from '../config/constants/tokens'
...
export const useCakeBusdPrice = (): Price | undefined => {
  ...
  const cakeBusdPrice = useBUSDPrice(DEFIY[currentChaindId])
